...
crafts = [
	{:name => "Ruby on Rails", :short_description => "Ruby on Rails is a framework for building web applications", :long_description => "Ruby on Rails is a framework for building web applications.", :image_url => "assets/images/seed/rails.png", :path => "ruby-on-rails", :full_path => "/computer-programming/ruby-on-rails"},
